...
)
{
	...
	// Default SID for the comm port 
	status = FltBuildDefaultSecurityDescriptor(
		&sd,
		FLT_PORT_ALL_ACCESS // TODO: Change after POC to restrict alien access to port
	);
	...
	RtlInitUnicodeString(&port_name, TEXT("\\WindowsFileLockerCommPort"));
